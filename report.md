...
На данном скрине мы видим что пакеты обновились и после команды echo "nameserver 127.0.0.1" > /etc/resolv.conf пакеты больше обновится не смогли.

![4 part](images/4part.png)
